...
export function BlogPostPage() {
  ...
  const articleJsonLd = {
    ...
    image: post.heroImage || 'https://acupuncture-website-three.vercel.app/og-default.jpg',
    author: {
      '@type': 'Person',
      name: author?.name,
    ...
    mainEntityOfPage: {
      '@type': 'WebPage',
      '@id': `https://acupuncture-website-three.vercel.app/blog/${post.slug}`,
    },
  ...
  const breadcrumbJsonLd = {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        position: 3,
        name: post.title,
        item: `https://acupuncture-website-three.vercel.app/blog/${post.slug}`,
      },
    ],
  };
